...
#start message
START_MSG = os.environ.get("START_MESSAGE", "ʜᴇʟʟᴏ {first}✨,/n/n<b>ɪ ᴀᴍ ꜰɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ ʙʏ @itz_sahil_official❤️/nɪ ᴄᴀɴ sᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ꜰɪʟᴇs ɪɴ sᴘᴇᴄɪꜰɪᴇᴅ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴏᴛʜᴇʀ ᴜsᴇʀs ᴄᴀɴ ᴀᴄᴄᴇss ɪᴛ ꜰʀᴏᴍ sᴘᴇᴄɪᴀʟ ʟɪɴᴋ ᴀɴᴅ ᴛʜɪs ᴀʟʟ ʙᴇᴄᴀᴜsᴇ ᴏꜰ @itz_sahil_official ❤️‍🔥</b>/n<b>sᴏ ʙᴇ ɢʀᴀᴛᴇꜰᴜʟ ᴛᴏᴡᴀʀᴅs ᴍʏ ᴏᴡɴᴇʀ ᴡʜᴏ ᴄʀᴇᴀᴛᴇᴅ ᴍᴇ ᴡɪᴛʜ ᴛʜᴇɪʀ ʜᴀʀᴅᴡᴏʀᴋ🥀a</b>")
try:
    ADMINS=[]
